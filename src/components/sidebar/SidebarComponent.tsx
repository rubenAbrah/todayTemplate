...
function SidebarComponent({ showMenu, setShowMenu }) {
  ...
  return (
    <div
      className={`m15 br0375rem sidebarTextColor  width250 scrollbar sidebarBackground sidebarText sidebarHeight overflowXhidden fixed p20 ${
        showMenu ?  '' : "mlMinus280px"
      }`}
    >
      <div 
        className="positionAbsolute clossButton topAndRight0"
      >
        <span 
